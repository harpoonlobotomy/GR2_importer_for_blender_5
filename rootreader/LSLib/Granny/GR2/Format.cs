...
public class StructReference : RelocatableReference
{
    ...
    public StructDefinition Resolve(GR2Reader gr2)
    {
        ...
        //        Console.Write(gr2.Types); // System.Collections.Generic.Dictionary`2[rootreader.LSLib.Granny.GR2.StructReference,rootreader.LSLib.Granny.GR2.StructDefinition]System.Collections.Generic.Dictionary`2[rootreader.LSLib.Granny.GR2.StructReference,rootreader.LSLib.Granny.GR2.StructDefinition]
        return Type;
    }
...
public class MemberDefinition
{
    ...
    public IVariantTypeSelector TypeSelector;
    ...
    private void LoadAttributes(FieldInfo info, GR2Writer writer)
    {
        ...
        if (attrs.Length > 0)
        {
            ...
            if (serialization.TypeSelector != null)
                TypeSelector = Activator.CreateInstance(serialization.TypeSelector) as IVariantTypeSelector;

            if (serialization.SectionSelector != null)
                SectionSelector = Activator.CreateInstance(serialization.SectionSelector) as ISectionSelector;

            if (serialization.Serializer != null)
                Serializer = Activator.CreateInstance(serialization.Serializer) as INodeSerializer;
    ...
    public System.Reflection.FieldInfo LookupFieldInfo(object instance)
    {
        ...
        //Console.Write(field); //System.String FromFileNameSystem.Collections.Generic.List`1[rootreader.LSLib.Granny.Model.Skeleton] SkeletonsSystem.String NameSystem.Collections.Generic.List`1[rootreader.LSLib.Granny.Model.Mesh] MeshesSystem.String NameSystem.String NameSystem.String NameSystem.String NameSystem.String NameSystem.Collections.Generic.List`1[rootreader.LSLib.Granny.Model.Model] ModelsSystem.String NameSystem.Collections.Generic.List`1[rootreader.LSLib.Granny.Model.TrackGroup] TrackGroupsSystem.Collections.Generic.List`1[rootreader.LSLib.Granny.Model.Animation] Animations
        // Define which field names are allowed
        var allowedFields = new[]
        {
        "FromFileName", "Textures", "Materials",
        "Skeletons", "Meshes", "Models",
        "TrackGroups", "Animations", "Name", "Game"
    };
        // Only continue if the field exists and is allowed
        //if (field != null && allowedFields.Contains(field.Name))
        if (field != null)// && !disallowedFields.Contains(field.Name)) // testing excluding bones to include more metadata so hopefully it doesn't error with "Game" in blender import process.         // removed this, not needed.
        {
            if (HasCachedField)
                return CachedField;
        ...
        // Otherwise, do nothing or return null
        return null;
    }
    ...
    public static MemberDefinition CreateFromFieldInfo(FieldInfo info, GR2Writer writer)
    {
        ...
        // Console.Write("Does this get printed? memberdefinition"); UNUSED?
...
public class StructDefinition
{
    ...
    public void MapType(object instance)
    {
        if (Type == null)
        {
            ...
            //Console.Write(Type);  //  == rootreader.LSLib.Granny.Model.Rootrootreader.LSLib.Granny.Model.Skeletonrootreader.LSLib.Granny.Model.Meshrootreader.LSLib.Granny.Model.Model
        }
    ...
    public void LoadFromType(Type type, GR2Writer writer) // UNUSED?
    {
        Type = type;
